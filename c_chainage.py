...
class Chainage: # On définit notre classe, que l'on appelle "Chainage"
	...
	def __init__(self, texte, ReponsesArray, indice, posChainage = False, mikeTexte = False): # Constructeur qui prend en paramètre la phrase et le tableau de réponses
		self.indice = indice
